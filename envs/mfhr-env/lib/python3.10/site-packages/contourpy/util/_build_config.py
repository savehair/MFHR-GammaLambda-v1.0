...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"/Users/runner/miniforge3/conda-bld/contourpy_1744743163818/_build_env/bin/python3.10",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/Users/runner/miniforge3/conda-bld/contourpy_1744743163818/work/.mesonpy-97kgohp0/lib/contourpy/util",
        source_dir=r"/Users/runner/miniforge3/conda-bld/contourpy_1744743163818/work/lib/contourpy/util",
        cross_build="True",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --cross-file=/Users/runner/miniforge3/conda-bld/contourpy_1744743163818/_build_env/meson_cross_file.txt --native-file=/Users/runner/miniforge3/conda-bld/contourpy_1744743163818/work/.mesonpy-97kgohp0/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
